...
Calling the executable must be of the form: PROGRAMNAME INTEGER FILENAME 

The executable takes two arguments (besides the program's own name). All arguments must be separated by any number of spaces.  Program arguments are as follows:
...
*Note that a letter is always lower case, and is found in the set {a,b,...,z}; note also that the empty string is not a word
